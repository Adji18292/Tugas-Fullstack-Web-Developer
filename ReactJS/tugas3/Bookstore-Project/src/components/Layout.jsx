...
// Terima props `books` dan `addBook`
function Layout({ books, addBook }) {
  return (
      ...
      <div className="container">
        <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom shadow-sm">
          ...
          <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><NavLink to="/album" className={({ isActive }) => `nav-link px-2 ${isActive ? 'link-dark fw-bold' : 'link-secondary'}`}>Book</NavLink></li>
          </ul>
